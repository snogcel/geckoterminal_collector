...
# Review Database Test Framework:
...
- See CLI, maybe fix first then do this task. *TroubleshootCLIUtility*
- Probably not passing test framework due to: *TroubleshootCLIUtility* 

# Troubleshoot CLI Utility (after other fixes are made) *TroubleshootCLIUtility* **SystemDocumentation**

⚡ Testing CLI Commands...
--------------------------------------------------
❌ analyze-pool-signals help failed: usage: cli.py [-h] [--version] [--config CONFIG] [--verbose] [--quiet]
              {init,validate,db-setup,start,stop,status,run-collector,backfill,export,cleanup,health-check,metrics,logs,backup,restore,build-ohlcv,validate-workflow,migrate-pool-ids,add-watchlist,list-watchlist,update-watchlist,remove-watchlist,collect-new-pools,analyze-pool-discovery,db-health,db-monitor}
              ...
cli.py: error: argument command: invalid choice: 'analyze-pool-signals' (choose from 'init', 'validate', 'db-setup', 'start', 'stop', 'status', 'run-collector', 'backfill', 'export', 'cleanup', 'health-check', 'metrics', 'logs', 'backup', 'restore', 'build-ohlcv', 'validate-workflow', 'migrate-pool-ids', 'add-watchlist', 'list-watchlist', 'update-watchlist', 'remove-watchlist', 'collect-new-pools', 'analyze-pool-discovery', 'db-health', 'db-monitor')

❌ monitor-pool-signals help failed: usage: cli.py [-h] [--version] [--config CONFIG] [--verbose] [--quiet]
              {init,validate,db-setup,start,stop,status,run-collector,backfill,export,cleanup,health-check,metrics,logs,backup,restore,build-ohlcv,validate-workflow,migrate-pool-ids,add-watchlist,list-watchlist,update-watchlist,remove-watchlist,collect-new-pools,analyze-pool-discovery,db-health,db-monitor}
              ...
cli.py: error: argument command: invalid choice: 'monitor-pool-signals' (choose from 'init', 'validate', 'db-setup', 'start', 'stop', 'status', 'run-collector', 'backfill', 'export', 'cleanup', 'health-check', 'metrics', 'logs', 'backup', 'restore', 'build-ohlcv', 'validate-workflow', 'migrate-pool-ids', 'add-watchlist', 'list-watchlist', 'update-watchlist', 'remove-watchlist', 'collect-new-pools', 'analyze-pool-discovery', 'db-health', 'db-monitor')
