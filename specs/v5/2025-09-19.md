...
2025-09-19 05:15:30,995 - gecko_terminal_collector.collectors.watchlist_monitor - ERROR - Error processing new record WatchlistRecord(symbol=FRIP, pool=B5TchhTV2fmbmniA5jnH4Q1Xa1r8ifVZWwnLhYX7pSn7): (psycopg2.errors.ForeignKeyViolation) insert or update on table "watchlist" violates foreign key constraint "watchlist_pool_id_fkey"
DETAIL:  Key (pool_id)=(B5TchhTV2fmbmniA5jnH4Q1Xa1r8ifVZWwnLhYX7pSn7) is not present in table "pools".

[SQL: INSERT INTO watchlist (pool_id, token_symbol, token_name, network_address, is_active, created_at, updated_at, metadata_json) VALUES (%(pool_id)s, %(token_symbol)s, %(token_name)s, %(network_address)s, %(is_active)s, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, %(metadata_json)s) RETURNING watchlist.id, watchlist.created_at, watchlist.updated_at]
[parameters: {'pool_id': 'B5TchhTV2fmbmniA5jnH4Q1Xa1r8ifVZWwnLhYX7pSn7', 'token_symbol': 'FRIP', 'token_name': 'FRIP', 'network_address': 'B5TchhTV2fmbmniA5jnH4Q1Xa1r8ifVZWwnLhYX7pSn7', 'is_active': True, 'metadata_json': '{}'}]
